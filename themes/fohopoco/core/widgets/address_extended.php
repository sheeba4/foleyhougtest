...
class X_Address_Extended_Widget extends WP_Widget {
  ...
  function __construct()
  {
    $options = array(
      ...
      'name'      => 'X Address Extended'
    );
    parent::__construct('X_Address_Extended_Widget', '', $options); // ID, Name, Options
  }
	...
	echo $before_widget;
		...
		echo "<div class='vcard'>";
			echo "<p>";
				...
				echo "</span>";
				echo "<a class='url' href='$url'>$url</a>";
			echo "</p>";
			echo "<p>";
...
// Init our widget
add_action('widgets_init', 'x_register_address_extended');
function x_register_address_extended()
{
  register_widget('X_Address_Extended_Widget');
}
