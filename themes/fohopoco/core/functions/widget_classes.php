...
class WidgetClasses {
	/**
     * Copy from http://blog.aizatto.com/widget-classes
	 ...
	 */
	static function sidebar_admin_setup() {
     ...
     */
	static function in_widget_form($widget, $return, $instance) {
     ...
     */
	static function form($id, $name, $value) { ?>
		<p>
			<label>
				Classes:
