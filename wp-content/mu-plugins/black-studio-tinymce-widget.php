...
Description: Adds a WYSIWYG widget based on the standard TinyMCE WordPress visual editor. NorthPoint updated plugin url for mu plugins.
Version: 1.3.3
Author: Black Studio
...
function black_studio_tinymce_scripts() {
	...
	$plugin_url = WPMU_PLUGIN_URL . '/black-studio-tinymce-widget/';
	if ( get_bloginfo( 'version' ) >= "3.3" ) {
		wp_enqueue_script( 'wplink' );
		wp_enqueue_script( 'wpdialogs-popup' );
		wp_enqueue_script( 'black-studio-tinymce-widget', ( $plugin_url . 'black-studio-tinymce-widget' . ($black_studio_tinymce_widget_dev_mode ? '.dev' : '' ) . '.js') , array( 'jquery', 'editor' ), $black_studio_tinymce_widget_version, true );
	}
	else {
		wp_enqueue_script( 'black-studio-tinymce-widget-legacy', ( $plugin_url . 'black-studio-tinymce-widget-legacy' . ($black_studio_tinymce_widget_dev_mode? '.dev' : '' ) . '.js' ), array( 'jquery', 'editor' ), $black_studio_tinymce_widget_version, true );
	}
}
...
function black_studio_tinymce_styles() {
    ...
    wp_enqueue_style( 'black-studio-tinymce-widget', ( $plugin_url . 'black-studio-tinymce-widget.css' ), array(), $black_studio_tinymce_widget_version );
}
